...
const contactInfo = [
  {
    icon: MapPin,
    label: "Address",
    value: "Jl. Babarsari No.43, Janti, Caturtunggal, Kec. Depok, Kabupaten Sleman, Daerah Istimewa Yogyakarta 55281"
  },
  {
    icon: Mail,
    label: "Email",
    value: "acsjaya2317@gmail.com"
  },
  {
    icon: Phone,
    label: "Phone",
    value: "(+62) 878-7428-9382"
  },
  {
    icon: Clock,
    label: "Hours",
